...
public class FakeScoreRepository implements ScoreRepository {
    ...
    public void loadScores() {
        new Thread(() -> {
            ...
            final Map<Integer, Player> scores = createScores();
            delay(500);
            new Handler(Looper.getMainLooper()).post(() -> listener.onScoresLoaded(scores));
        }).start();
    }
